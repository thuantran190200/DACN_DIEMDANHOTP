...
public class frament_home extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_attendance_sv = (Button) view.findViewById(R.id.btn_opentest);

        btn_attendance_sv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), attendance_sv.class);
